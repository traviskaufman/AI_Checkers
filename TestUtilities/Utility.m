...
%this pits the same ai against itself
%accounts for protected pieces
value = 0;
    ...
    for column=1:8
        for row=1:8
            if (mod(column+row,2)~=0)
                ...
                if ( piece ==1) %friendly pawn piece
                    weight = 1;
    ...
    for column=1:8
            for row=1:8
                if (mod(column+row,2)~=0)
                    ...
                    % Count pieces and assign weight values
                    if ( piece == 2) %friendly pawn piece
                        weight = 1;

                    elseif (piece == 4)%friendly king piece
                        weight = 2;

                    elseif ( piece == 1) %enemy pawn piece
                        weight = -1;

                    elseif ( piece == 3) %enemy king piece
                        weight = -2;
                    end
                    ...
                    %add utility for protected pieces
                        ...
                        %pieces on the side
                         ...
                         %pieces with column piece diagonally behind it
                         if( (piece == 2 || piece ==4) &&(pieceTopLeft == 2 || pieceTopLeft ==4))
                             weight = 0.2 + weight;
                         elseif ( (piece == 2 || piece ==4) && (pieceTopRight == 2 || pieceTopRight ==4))
                             weight = 0.2 + weight;
                         %utility bonus if it is protected with 2 pieces
                         elseif ( (piece == 2 || piece ==4) && (pieceTopLeft == 2 || pieceTopLeft ==4) && (pieceTopRight == 2 || pieceTopRight ==4))
                             weight = 0.2 + weight;
                         end
                    ...
                    %subtract utility for enemy protected pieces
                        ...
                        %enemy pieces on the side
                         ...
                         %enemy pieces with a piece diagonaly behind it
                         if( (piece == 1 || piece ==3) &&(pieceBottomLeft == 1 || pieceBottomLeft ==3))
                             weight = 0.2 - weight;
                         elseif ( (piece == 1 || piece ==3) && (pieceBottomRight == 1 || pieceBottomRight ==3))
                             weight = 0.2 - weight;
                         %utility bonus if it is protected with 2 pieces
                         elseif ( (piece == 1 || piece ==3) && (pieceBottomLeft == 1 || pieceBottomLeft ==3) && (pieceBottomRight == 1 || pieceTopRight ==3))
                             weight = 0.2 - weight;
                         end
